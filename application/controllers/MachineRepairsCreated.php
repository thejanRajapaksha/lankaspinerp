...
class MachineRepairsCreated extends Admin_Controller
{
    public function __construct()
    {
        ...
        $this->data['page_title'] = 'Machine Repairs Created';
    ...
    {
        if(!in_array('viewMachineRepairCreated', $this->permission)) {
            redirect('dashboard', 'refresh');
        }
        $this->data['js'] = 'application/views/MachineRepairs/MachineRepairsCreated/index-js.php';
        $this->render_template('MachineRepairs/MachineRepairsCreated/index', $this->data);
    }
    ...
    public function fetchCategoryData()
    {
        ...
        foreach ($data as $key => $value) {
            ...
            if($value['is_completed'] == 0){
                if(in_array('createMachineRepairCreatedComplete', $this->permission)) {
                ...
                if(in_array('createMachineRepairCreatedCompleteRemove', $this->permission)) {
            ...
            if(in_array('updateMachineRepairCreated', $this->permission)) {
            ...
            if(in_array('deleteMachineRepairCreated', $this->permission)) {
