	...
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	if($create == true) {
        		...
        		$this->session->set_userdata('errors', 'Error occurred!!');
            ...
            $factory_data = $this->model_factories->getFactoriesData();
            $this->data['factory_data'] = $factory_data;
		...
		if($id) {
			if($this->input->post('confirm')) {
					...
					if($delete == true) {
		        		...
		        		$this->session->set_userdata('error', 'Error occurred!!');
