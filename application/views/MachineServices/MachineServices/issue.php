    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col">
                    <?php if (in_array('createMachineServiceItemIssue', $user_permission)): ?>
            ...
            <div class="table-responsive">
                <table id="manageTable" class="table table-bordered table-striped table-sm">
                    ...
                    <tr>
                        ...
                        <?php if (in_array('updateMachineServiceItemIssue', $user_permission) || in_array('deleteMachineServiceItemIssue', $user_permission)): ?>
                            <th>Action</th>
                        <?php endif; ?>
                    </tr>
                    </thead>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="addModal">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form role="form" action="<?php echo base_url('MachineServices/issue_new') ?>" method="post"
                      id="createForm">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="editModal">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form role="form" action="<?php echo base_url('MachineServices/update_issue') ?>" method="post"
                      id="updateForm">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form role="form" action="<?php echo base_url('MachineServices/remove_issue') ?>" method="post"
                      id="removeForm">
                    <div class="modal-body">
