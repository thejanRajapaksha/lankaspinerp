  ...
  $.ajax({
    ...
    success:function(response) {
      ...
      $("#edit_active").val(response.active);
        ...
        let optionSection = new Option(response.factory_name, response.section_id, true, true);
        $('#edit_factory_id').append(optionSection).trigger('change');
