                ...
                <form role="form" action="<?php echo base_url('MachineIns/create') ?>" method="post" id="createForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="factory_id" id="factory_id" class="form-control-sm">
            ...
            <div class="modal-content">
                ...
                <form role="form" action="<?php echo base_url('MachineIns/update') ?>" method="post" id="updateForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="edit_factory_id">Factory <span class="text-danger">*</span></label>
                            <select name="factory_id" id="edit_factory_id" class="form-control-sm">
                            </select>
                            <div id="edit_factory_id_error"></div>
                        </div>
