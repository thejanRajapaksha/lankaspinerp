            ...
            success: function(response) {
                ...
                if (response.success === true) {
                    ...
                    if (machine_repair_data != 0) {
                        html3 +=
                            '<input type="hidden" id="allocate_from_repair_repair_id" name="repair_id" value="' +
                            machine_repair_data.id + '"> ';
                    }
                    ...
                    if (machine_allocation_data != 0) {
                        ...
                        html2 += '<div class="col">';
                        html2 +=
                            '<a href="#" class="btn btn-warning btn-sm m-1 machine_release" data-machine_in_id="' +
                            machine_allocation_data.machine_in_id +
                            '" data-toggle="modal" data-target="#removeModal" > Release</a>';
                        html2 +=
                            '<a href="#" class="btn btn-success btn-sm m-1 allocate" data-machine_in_id="' +
                            machine_allocation_data.machine_in_id +
                            '" data-toggle="modal" data-target="#allocateModal"> Re-Allocate</a>';
                        html2 +=
                            '<a href="#" class="btn btn-danger btn-sm m-1 repair" data-machine_in_id="' +
                            machine_allocation_data.machine_in_id +
                            '" data-toggle="modal" data-target="#repairModal" >  Repair</a>';
                        html2 += '</div>';
                        html2 += '</div>';
                    ...
                    if (machine_repair_data != 0) {
                        ...
                        html4 += '<div class="col">';
                        html4 +=
                            '<a href="#" class="btn btn-warning btn-sm m-1 repair_release" data-id="' +
                            machine_repair_data.id + '" data-machine_in_id="' + machine_repair_data
                            .machine_in_id +
                            '" data-toggle="modal" data-target="#repairReleaseModal" > Release</a>';
                        html4 +=
                            '<a href="#" class="btn btn-success btn-sm m-1 allocate_from_repair" data-id="' +
                            machine_repair_data.id + '" data-machine_in_id="' + machine_repair_data
                            .machine_in_id +
                            '" data-toggle="modal" data-target="#allocateFromRepairModal"> Re-Allocate</a>';
                        html4 += '</div>';
                        html4 += '</div>';
                    ...
                    if ((machine_allocation_data === 0) && (machine_repair_data === 0)) {
                        ...
                        html5 +=
                            '<a href="#" class="btn btn-success btn-sm m-1 allocate" data-machine_in_id="' +
                            machine_in_data.id +
                            '" data-toggle="modal" data-target="#allocateModal"> Allocate</a>';
                        html5 +=
                            '<a href="#" class="btn btn-danger btn-sm m-1 repair" data-machine_in_id="' +
                            machine_in_data.id +
                            '" data-toggle="modal" data-target="#repairModal" >  Repair</a>';
                    ...
                    html_mah += '</div>';
                    html_mah +=
                        '<div class="card-body table-responsive" style="padding: 10px !important;">';
                    html_mah +=
                        '<table class="table table-sm table-striped" id="tbl_allocation_history">';
                    html_mah += '<thead>';
                    html_mah += '<tr>';
                    html_mah += '<th> Slot </th>';
                    html_mah += '<th> Line </th>';
                    ...
                    html_mar +=
                        '<div class="card-body table-responsive" style="padding: 10px !important;">';
                    html_mar +=
                        '<table class="table table-sm table-striped" id="tbl_repair_history">';
                    html_mar += '<thead>';
                    html_mar += '<tr>';
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success === true) {
                    ...
                    $("#allocateForm .form-group").removeClass('has-error').removeClass(
                        'has-success');
                    scan();
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success === true) {
                    ...
                    $("#allocateFromRepairModal .form-group").removeClass('has-error')
                        .removeClass('has-success');
                    scan();
