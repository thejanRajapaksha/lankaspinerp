        				...
        				<div class="row">
        					<div class="col-9">
        						<form action="<?php echo base_url() ?>Customercontact/Customercontactinsertupdate" method="post" autocomplete="off">
									...
									<input type="hidden" name="customerid" id="customerid" value="<?php echo isset($result['Customercontactdetails'][0]->tbl_customer_idtbl_customer) ? $result['Customercontactdetails'][0]->tbl_customer_idtbl_customer : ''; ?>">
        						</form>
								<input type="hidden" name="hiddenid" id="hiddenid" value="<?php echo isset($result['Customercontactdetails'][0]->tbl_customer_idtbl_customer) ? $result['Customerbankdetails'][0]->tbl_customer_idtbl_customer : ''; ?>">
