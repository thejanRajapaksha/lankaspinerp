...
//.link_employee_thumb on click
$(document).on('click', '.link_employee_thumb', function (e) {
  let employee_id = $(this).attr('data-employee_id');

  $.ajax({
    url: base_url + 'Employees/employee_thumbnail/' + employee_id,
    type: 'post',
    dataType: 'html',
    success: function (response) {
      $('.employee_thumb').html(response);
    }
